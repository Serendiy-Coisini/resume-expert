...
export function InterviewStep() {
  const { userInput, analysisResult, partialAnalysisResult, setCurrentStep } = useResumeStore(useShallow((state) => ({ userInput: state.userInput, analysisResult: state.analysisResult, partialAnalysisResult: state.partialAnalysisResult, setCurrentStep: state.setCurrentStep })));

  const effectiveResult = analysisResult || partialAnalysisResult;

  if (!effectiveResult || !effectiveResult.interviewPrep) {
    return (
      <EmptyState
  ...
  const { interviewPrep } = effectiveResult;
